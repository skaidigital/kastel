  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        forceMount
        className={cn(
          'fixed z-30 flex h-screen w-full max-w-md flex-col rounded-project border-brand-border bg-white transition-[transform,opacity]  will-change-[transform,opacity] focus:outline-none',
          placement === 'bottom' &&
...
function DrawerTrigger({ children, className, asChild = true }: DrawerTriggerProps) {
  return (
