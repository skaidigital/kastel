...
import { ShoePickerContextProvider } from '@/components/shared/PageBuilder/ShoePickerSection/ShoePickerContext';
          ...
          <CarouselContent className="-ml-0 divide-x divide-brand-light-grey">
            {activeType?.items.map((item, index) => {
              if (item.type === 'product') {
                return (
                  <CarouselItem
                    ...
                    className="basis-[80%] pl-0 lg:basis-[25%]"
                  >
                    <ProductCard
                      title={item.title}
                      gid={item.gid}
              ...
              return (
                <CarouselItem
                  key={index}
                  className="relative h-auto basis-[80%] pl-0 lg:basis-[25%]"
                >
