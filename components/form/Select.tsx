...
const styles = tv({
  extend: focusRing,
  base: 'flex items-center text-start gap-4 w-full cursor-default border border-brand-border dark:border-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] dark:shadow-none rounded-project pl-3 pr-2 py-2 min-w-[150px] transition dark:bg-zinc-700',
  variants: {
    isDisabled: {
      false:
...
export function Select<T extends object>({
  ...
  return (
    ...
    >
      ...
      <Popover className="z-50 min-w-[--trigger-width]">
        <ListBox
          items={items}
