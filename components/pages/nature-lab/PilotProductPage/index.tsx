...
import { DesktopProductGallery } from '@/components/pages/ProductPage/DesktopProductGallery'
import { DiscountBadge } from '@/components/pages/ProductPage/DiscountBadge'
...
export function PilotProductPage({ product, market, lang }: Props) {
  const {
    mainImage,
    mainCategory,
    lifestyleImage,
  ...
  return (
    <ProductPageContextProvider>
      ...
      <Section
        ...
        className="gap-y-5 bg-nature-lab-beige pb-9 lg:flex border-none"
      >
