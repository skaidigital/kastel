...
module.exports = {
  ...
  theme: {
    ...
    animation: {
      ...
      'drawer-left-show': 'drawer-left-show 1000ms var(--ease-out-quad)',
      'drawer-left-hide': 'drawer-left-hide 1000ms var(--ease-out-quad)',
      'drawer-bottom-show': 'drawer-bottom-show 1000ms var(--ease-out-quad)',
      'drawer-bottom-hide': 'drawer-bottom-hide 1000ms var(--ease-out-quad)',
