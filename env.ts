...
// TODO test if the NODE_ENV works as expected in all environments and if so change all
// process.env.NODE_ENV to env.NODE_ENV
export const env = createEnv({
  server: {
    ...
    // PRODUCT_SYNC_SECRET_KEY: z.string().min(1)
  },
  client: {
    //   Base
    NEXT_PUBLIC_MARKET: z.enum(['no', 'sv', 'dk', 'eu']),
